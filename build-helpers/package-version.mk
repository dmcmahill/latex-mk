...
EXTRA_DIST += $(top_srcdir)/$(BUILD_SCRIPT_DIR)/package-version.sh
git-version-check:
	@git_ver=`$(top_srcdir)/$(BUILD_SCRIPT_DIR)/package-version.sh $(top_srcdir) version-stamp`; \
...
$(A_V).h.stamp:
	@current_ver=`$(SHELL) $(top_srcdir)/$(BUILD_SCRIPT_DIR)/package-version.sh $(top_srcdir) version-stamp`; \
